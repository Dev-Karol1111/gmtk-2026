...
func adjust_image():
	if Management.time == 24: image.play("24")
	elif Management.time >= 20: image.play("20")
	elif Management.time >= 16: image.play("16")
	elif Management.time >= 12: image.play("12")
	elif Management.time >= 8: image.play("8")
	else: image.play("4")
